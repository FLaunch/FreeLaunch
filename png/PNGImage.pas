...
type
  ...
  public
    ...
    procedure LoadFromResourceName(Instance: HInst; const Name: String; RT: String = '');
...
procedure TPngObject.LoadFromResourceName(Instance: HInst; const Name: String; RT: String = '');
var
  ResStream: TResourceStream;
begin
  {Creates an especial stream to load from the resource}
  try ResStream := TResourceStream.Create(Instance, Name, PChar(RT));
