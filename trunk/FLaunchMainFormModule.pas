...
var
  ...
  SettingsMode: byte; //–ежим работы (0 - инсталл€ци€, настройки хран€тс€ в APPDATA; 1 - инсталл€ци€, настройки хран€тс€ в папке программы; 2 - портабельный режим, инсталл€ци€, настройки хран€тс€ в папке программы)
...
begin
  ...
  if fileexists(workdir + '.session') then
    ...
    begin
      LoadLinksFromCash;
      //--—оздаем файл, который будет идентифицировать сессию. ѕри корректном завершении программы файл будет удален
